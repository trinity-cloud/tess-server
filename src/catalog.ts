  ...
  const definitions: Array<Parameters<typeof makeEntry>[1]> = [
    {
      ...
      capabilities: ['tools', 'reasoning', 'target-only', '32K context'],
    ...
    },
    {
      ...
      featured: true,
      downloadEnabled: true,
      capabilities: ['tools', 'reasoning', 'MTP', '128K recommended'],
      sourcePath: name => name,
    },
    {
      id: 'muse-glimmer-30b-kquant-dflash',
      profileId: 'muse-glimmer-30b-kquant-dflash',
      displayName: 'Muse Glimmer 30B',
      description: 'Compact multimodal and agent model with DFlash acceleration.',
      repository: 'meta-models/Muse-Glimmer-30B-GGUF',
      revision: 'b1f3e6ec2209678b3f29525bb9646286866f1675',
      licenseName: 'Apache-2.0',
      licenseUrl: 'https://huggingface.co/meta-models/Muse-Glimmer-30B-GGUF/blob/b1f3e6ec2209678b3f29525bb9646286866f1675/LICENSE',
      memoryClassGiB: 64,
      destinationSlug: 'muse-glimmer-30b',
      featured: true,
      downloadEnabled: true,
      capabilities: ['tools', 'vision-ready', 'DFlash'],
      sourcePath: name => name,
    },
    {
      id: 'minimax-m27-iq4xs',
      profileId: 'minimax-m27-iq4xs',
      displayName: 'MiniMax M2.7',
      description: 'Long-context 128 GiB flagship.',
      repository: 'unsloth/MiniMax-M2.7-GGUF',
      revision: 'd2a05ccf69491b03db0cc40b335aec14bdaf7198',
      licenseName: 'MiniMax Modified MIT License',
      licenseUrl: 'https://github.com/MiniMax-AI/MiniMax-M2.7/blob/main/LICENSE',
      memoryClassGiB: 128,
      destinationSlug: 'minimax-m27-iq4xs',
      featured: true,
      downloadEnabled: true,
      capabilities: ['tools', 'reasoning', '192K trained context'],
      sourcePath: name => `UD-IQ4_XS/${name}`,
    },
    {
      id: 'deepseek-v4-flash-0731-gguf-dspark',
      profileId: 'dsv4-0731-dspark',
      displayName: 'DeepSeek V4 Flash · GGUF',
      description: 'High-throughput GGUF alternative with DSpark.',
      repository: 'unsloth/DeepSeek-V4-Flash-0731-GGUF',
      revision: 'fbbb5b93fb787c21338159b0af3318bb3f4d9768',
      licenseName: 'MIT',
      licenseUrl: 'https://huggingface.co/unsloth/DeepSeek-V4-Flash-0731-GGUF/blob/fbbb5b93fb787c21338159b0af3318bb3f4d9768/README.md',
      memoryClassGiB: 128,
      destinationSlug: 'deepseek-v4-flash-0731-gguf',
      featured: true,
      downloadEnabled: false,
      downloadUnavailableReason: 'The exact public DSpark companion revision is not frozen yet; add an existing local copy.',
      capabilities: ['tools', 'reasoning', 'DSpark'],
      sourcePath: (name, draft) => draft ? name : `UD-IQ3_XXS/${name}`,
    },
  ];
